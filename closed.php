...
<!-- header -->
	...
	<!-- page content -->
		<div id="container">
			...
			<a name="here"></a>
			<div id="closed">
				<h2><span>The Wheel of Fortune<br /><em>V8&reg;</em> Sweepstakes</span><br />is now closed.</h2>
				<p>You will be contacted if you are selected as a winner.<br />Thank you for your interest!</p>
			</div>
		...
		<script type="text/javascript"> 
		  s.pageName="us:tv:shows:wheel:minisites:wheelv8:closed.php"
