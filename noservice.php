...
<!-- header -->
	...
	<!-- page content -->
		<div id="container">
			...
			<a name="here"></a>
			<div id="noservice">
				<h2>Sorry, we cannot<br /><span>offer you service at this time.</span></h2>
				<p>Please visit <span><a rel="external" class="wheeloffortune_text promotion" href="http://www.wheeloffortune.com/">WheelofFortune.com</a></span> to see what else we have in store.</p>
			</div>
		...
		<script type="text/javascript"> 
		   s.pageName="us:tv:shows:wheel:minisites:wheelv8:noservice.php"
